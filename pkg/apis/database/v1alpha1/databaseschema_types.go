...
// DatabaseSchemaSpec defines the desired state of DatabaseSchema
...
// DatabaseSchema is the Schema for the databaseschemas API
...
// DatabaseSchemaList contains a list of DatabaseSchema
